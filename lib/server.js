...
function Server() {
  ...
  this.server = http.createServer(function (req, res) {
    ...
    if (req.method === 'GET') {
      switch (req.url) {
        case '/bootstrap.css': return serveFile('bootstrap.css', 'text/css', res);
        case '/bootstrap.js': return serveFile('bootstrap.js', 'text/javascript', res);
        case '/': return serveFile('index.html', 'text/html', res);
        case '/index.js': return serveFile('index.js', 'text/javascript', res);
        case '/jquery-1.11.1.min.js': return serveFile('jquery-1.11.1.min.js', 'text/javascript', res);
        case '/jquery.cookie.js': return serveFile('jquery.cookie.js', 'text/javascript', res);
        case '/jquery.timeago.js': return serveFile('jquery.timeago.js', 'text/javascript', res);
        ...
        case '/fonts/glyphicons-halflings-regular.ttf': return serveFile('fonts/glyphicons-halflings-regular.ttf', 'font/ttf', res);
        case '/fonts/glyphicons-halflings-regular.woff': return serveFile('fonts/glyphicons-halflings-regular.woff', 'application/font-woff', res);
        case '/fonts/glyphicons-halflings-regular.svg': return serveFile('fonts/glyphicons-halflings-regular.svg', 'image/svg+xml', res);
        case '/bootstrap.css.map': return serveFile('bootstrap.css.map', 'application/octet-stream', res);
      }
    }
